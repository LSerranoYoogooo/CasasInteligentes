...
//SITIOS
DELIMITER $$ 
CREATE PROCEDURE set_Site( IN usr_id VARCHAR( 160 ), IN name VARCHAR( 160 ), IN latitud VARCHAR( 160 ),  IN longitud VARCHAR( 160 ), IN img VARCHAR( 10 ), IN ip_address VARCHAR( 160 ), IN ip_port VARCHAR( 160 ), OUT sti_id VARCHAR( 160 ))
BEGIN
DECLARE ID INT;
