...
if (!empty($_POST)) {
  ...
  try{
    ...
    $sql = $conn->prepare("SELECT usr_id, usr_name, usr_email, usr_service_type, default_site FROM user_app WHERE usr_id = :user_id");
  	$sql->execute(array('user_id' => $_POST['usr_id']));
